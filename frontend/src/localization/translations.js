export const translations = {
  te: {
    ...
    cropDoctor: {
      ...
      top3Predictions: '📊 టాప్ 3 అంచనాలు (Top 3 Predictions)',
      scanHistoryTitle: '📜 మునుపటి వ్యాధి స్కాన్ చరిత్ర (Scan History)',
  ...
  hi: {
    ...
    cropDoctor: {
      title: '📷 फसल बीमारी जांच Pipeline',
      ...
      retakeBtn: '📸 साफ़ फ़ोटो पुनः खींचें ➔',
      cropDisease: 'फसल रोग',
      ...
      observedSymptoms: 'लक्षण',
      diseaseCause: 'बीमारी का मुख्य कारण',
      immediateTreatment: 'तत्काल उपचार',
      preventionTips: 'बचाव के उपाय',
      top3Predictions: '📊 टॉप 3 पूर्वानुमान (Top 3 Predictions)',
      scanHistoryTitle: '📜 पिछला स्कैन इतिहास (Scan History)',
  ...
  ta: {
    ...
    cropDoctor: {
      ...
      retakeBtn: '📸 புதிய படம் எடுக்கவும் ➔',
      ...
      diseaseCause: 'நோய்க்கான முக்கிய காரணம்',
      immediateTreatment: 'உடனடி சிகிச்சை',
      preventionTips: 'தடுப்பு முறைகள்',
      top3Predictions: '📊 சிறந்த 3 கணிப்புகள் (Top 3 Predictions)',
      scanHistoryTitle: '📜 பழைய ஆய்வு வரலாறு (Scan History)',
  ...
  kn: {
    ...
    cropDoctor: {
      ...
      diseaseCause: 'ರೋಗಕ್ಕೆ ಕಾರಣ',
      immediateTreatment: 'ತಕ್ಷಣದ ಚಿಕಿತ್ಸೆ',
      preventionTips: 'ಮುನ್ನೆಚ್ಚರಿಕೆ ಕ್ರಮಗಳು',
      top3Predictions: '📊 ಟಾಪ್ 3 ಅಂದಾಜುಗಳು (Top 3 Predictions)',
      scanHistoryTitle: '📜 ಹಳೆಯ ತಪಾಸಣೆ ಇತಿಹಾಸ (Scan History)',
  ...
  mr: {
    ...
    cropDoctor: {
      ...
      immediateTreatment: 'त्वरित उपचार',
      preventionTips: 'प्रतिबंधात्मक उपाय',
      top3Predictions: '📊 टॉप 3 अंदाज (Top 3 Predictions)',
      scanHistoryTitle: '📜 जुना तपासणी इतिहास (Scan History)',
  ...
  bn: {
    ...
    cropDoctor: {
      ...
      diseaseCause: 'রোগের প্রধান কারণ',
      immediateTreatment: 'তাৎক্ষণিক চিকিৎসা',
      preventionTips: 'প্রতিরোধমূলক টিপস',
      top3Predictions: '📊 সেরা ৩টি অনুমান (Top 3 Predictions)',
      scanHistoryTitle: '📜 পূর্ববর্তী স্ক্যান ইতিহাস (Scan History)',
  ...
  gu: {
    ...
    cropDoctor: {
      ...
      diseaseCause: 'રોગનું મુખ્ય કારણ',
      immediateTreatment: 'ત્વરિત ઉપચાર',
      preventionTips: 'અગમચેતીના પગલાં',
      top3Predictions: '📊 ટોચના 3 અંદાજો (Top 3 Predictions)',
      scanHistoryTitle: '📜 જૂનો તપાસ ઇતિહાસ (Scan History)',
  ...
  en: {
    ...
    cropDoctor: {
      ...
      analyzing: 'Analyzing crop leaf (224x224 PlantVillage Model)...',
